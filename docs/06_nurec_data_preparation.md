...
`prepared_v6`. The condition/coverage pass used `schema_v5`, `audit_v7`, and
`prepared_v7`. The final contract-sync pass uses `schema_v6`, `audit_v8`, and
`prepared_v8`; none of these reports overwrite earlier outputs.
